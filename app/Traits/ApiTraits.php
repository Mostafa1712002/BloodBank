...
/*
 * v1
 * This function to handle get api
 * take three parames
 ** @status which the 1 refer to success 0 to fail
 ** @massage which the text will show to confirm the failer or success
 ** @object which refere to the object want to return data from it and have defalut value null

 */
    public function responseJson($status, $massage, $object = null)
    {
