                ...
                <div class="account-form">
                    ...
                    <form action="{{ route('client.register-save') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input id="d_o_b" class="form-control @error('d_o_b') is-invalid @enderror" name="d_o_b"
                                value="{{ date(old('d_o_b')) }}" type="date">
                            @error('d_o_b')
                                <span class="invalid-feedback d-block" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                            ...
                            <select name="blood_type_id" id="blood_type_id"
                                class="form-control @error('blood_type_id') is-invalid @enderror">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control  @error('governorate_id') is-invalid @enderror " id='governorates'
                                name='governorate_id'>
                        ...
                        <div class="form-group">
                            ...
                            <input name="last_donation_date"
                                class="form-control @error('last_donation_date') is-invalid @enderror "
                                value=" {{ date(old('last_donation_date')) }}" type="date" id="last_donation_date">
                ...
                $("#governorates").change(function() {
                    ...
                    if (governorateId) {
                        ...
                        $.ajax({
                            ...
                            url: '{{ route('auth.governorate') }}?governorate_id=' + governorateId,
                            success: function(data) {

                                if (data.status == 1) {
                                    $.each(data.data, function(index, cities) {
                                        $("#cities").append('<option value="' + cities.id +
                                            '">' + cities.name + '</option>');
                                    });
                                }
                            }
