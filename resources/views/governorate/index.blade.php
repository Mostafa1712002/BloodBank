    ...
    <div class="col-xl-12 col-md-12 col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <a class="btn btn-info mt-3 mb-1 ml-1 btn-sm" href="{{ route("governorate.create") }}"> <i class="fa fa-plus"></i> إنشاء محافظه جديده </a>
                @endif
                ...
                <table class="table  table-hover m-1">
                    ...
                    <tbody>
                        ...
                        <tr data-row="#row{{ $record->id }}" id="row{{ $record->id  }}">
                            ...
                            @if (auth()->user()->can("update-governorate"))
                            <td scope="row" class="text-center"> <a class=" btn btn-success btn-sm" href="{{ route("governorate.edit",$record->id)}}"> <i class="fa fa-edit"></i> </a>
                            </td>
                            @endif
                            @if (auth()->user()->can("destroy-governorate"))
                            <td scope="row" class="text-center">
                                <div class="btn btn-danger destroy btn-sm" data-route="{{ route("governorate.destroy",$record->id) }}" data-token="{{ csrf_token() }}">
