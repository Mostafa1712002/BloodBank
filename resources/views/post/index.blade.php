    ...
    <div class="col-xl-12 col-md-12 col-lg-12">
        ...
        <div class="card ">
            ...
            <div class="card-body table-responsive p-0">
                ...
                <a class="btn btn-info mt-3 mb-1 ml-1 btn-sm" href="{{ route("post.create") }}"> <i class="fa fa-plus"></i>أنشاء مقال جديد</a>
                @endif
                ...
                <table class="table  table-hover ">
                    ...
                    <tbody>
                        ...
                        <tr data-row="#row{{ $record->id }}" id="row{{ $record->id  }}">
                            ...
                            <td scope="row" class="text-center"><img src="{{ asset("$record->image") }}" style=" width:4pc ; height:4pc;"></td>
                            ...
                            @if (auth()->user()->can("update-post"))
                            <td scope="row" class="text-center"> <a class=" btn btn-success btn-sm" href="{{ route("post.edit",$record->id)}}"> <i class="fa fa-edit"></i> </a>
                            </td>
                            @endif

                            @if (auth()->user()->can("destroy-post"))
                            <td scope="row" class="text-center">
                                <div class="btn btn-danger destroy btn-sm" data-route="{{ route("post.destroy",$record->id) }}" data-token="{{ csrf_token() }}">
