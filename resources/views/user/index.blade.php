    ...
    <div class="col-xl-12 col-md-12 col-lg-12">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <a class="btn btn-info mt-3 mb-1 ml-1 btn-sm" href="{{ route("user.create") }}"> <i class="fa fa-plus"></i>إنشاء مستخدم جديده</a>
                @endif
                ...
                <table class="table  table-hover m-1">
                    ...
                    <tbody>
                        ...
                        @if(auth()->user()->can("update-user"))
                        <th scope="row" class="text-center"> <a class=" btn btn-success btn-sm" href="{{ route("user.edit",$user->id)}}"> <i class="fa fa-edit"></i> </a>
                        </th>
                        @endif
                        @if(auth()->user()->can("destroy-user"))
                        <th scope="row" class="text-center">
                            <div class="btn btn-danger destroy btn-sm" data-route="{{ route("user.destroy",$user->id) }}" data-token="{{ csrf_token() }}">
